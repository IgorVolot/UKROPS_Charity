...
const OurMission = () => {
  return (
    <>
      <img className={`${style.img} `} src={big_logo} alt="big_logo" />
      ...
      <div className={`${style.container} my-5 border border-secondary shadow ju`} data-bs-spy="scroll"
        ...
        <p className={style.text}>
          ...
          and appreciate and respond to the real situation on the ground.
        </p>
        <p className={style.text}>
          ...
          that Dr Krivskiy is planning to embark upon in January 2025.
        </p>
        <p className={style.text}>
          ...
          major trauma with limited resources in an unsafe environment.
        </p>
        <p className={style.text}>
          ...
          We are starting small, but we are aiming big!
        </p>
      </div>
      <div>
